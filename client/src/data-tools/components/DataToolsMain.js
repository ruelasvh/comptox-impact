...
class DataToolsIndex extends React.Component {
    ...
    render() {
      ...
      const tablist = [
        ...
        { name: 'CPCat', eventKey: 'third', data: analytics.cpcat, description: "CPCat (Chemical and Product Categories) is a database containing information mapping more than 43,000 chemicals to a set of terms categorizing their usage or function." },
